...
public class Cat {
	...
	private static final int HEAD_DIMENSION = 180;
	...
	//changed the mouth x and y dimensions to make it lower
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		int y=catY;
		// Draw the head
		//changed color from black to pink
		...
		//changed meow to a lot more meow
		g2.drawString("MEEEEEEOWWWWWWW", catX, catY+HEAD_DIMENSION+10);	
	}
}
